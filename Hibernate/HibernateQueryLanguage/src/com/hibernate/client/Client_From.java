...
public class Client_From {
	...
	public static void main(String[] args) {
		...
		/*	//save
			Book b1=new Book(101,"Let Us C","YK",879);
			Book b2=new Book(102,"Complete Reference C++","HS",1200);
			Book b3=new Book(103,"Thinking in Java","KS",1500);
			Book b4=new Book(104,"Inside Android","GT",1267);
			Book b5=new Book(105,"Python Programming","MP",2500);
